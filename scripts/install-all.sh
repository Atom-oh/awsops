...
echo "    Step 6:  AgentCore (all)          (06-setup-agentcore.sh)"
...
echo "    bash scripts/06-setup-agentcore.sh            # AgentCore (all 4 sub-steps)"
echo "      or individually:"
echo "      bash scripts/06a-setup-agentcore-runtime.sh # Runtime + ECR + Endpoint"
echo "      bash scripts/06b-setup-agentcore-gateway.sh # Gateway (MCP)"
echo "      bash scripts/06c-setup-agentcore-tools.sh   # Lambda + Gateway Targets"
echo "      bash scripts/06d-setup-agentcore-interpreter.sh # Code Interpreter"
