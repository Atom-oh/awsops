...
const ROWS = [
  { account_id: '123456789012', region: 'ap-northeast-2', rule_id: 'sgr-1', group_id: 'sg-1', is_egress: false, protocol: 'tcp', from_port: 443, to_port: 443, peer_kind: 'cidr', peer_value: '10.0.0.0/16', description: null, compatible_match_count: 3, overlap_match_count: 0, last_observed_at: null, status: 'observed_compatible' },
