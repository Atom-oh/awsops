...
- 대상: `https://awsops-v2.atomai.click` (계정 `180294183052`, ap-northeast-2, Cobalt 기본 테마)
...
- 대시보드/리포트/어시스턴트에 **실제 비용 수치**($16,547.88, 서비스별 금액), **계정 ID `180294183052`**(AI 진단 리포트 본문), 리소스 개수, 보안 카운트 노출.
