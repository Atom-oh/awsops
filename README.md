...
Stats: 40 pages, 99 API routes, 104 components (`web/`), 20 consolidated ADRs, Terraform-managed (`terraform/v2/foundation`, no CDK).
...
```
awsops/
  web/                    # Next.js 14 thin-BFF: 40 pages, 99 API routes, 104 components
...
현황: 40 페이지, 99 API 라우트, 104 컴포넌트(`web/`), 20개 통합 ADR, Terraform 관리(`terraform/v2/foundation`, CDK 없음).
...
```
awsops/
  web/                      # Next.js 14 thin-BFF: 40 페이지, 99 API 라우트, 104 컴포넌트
