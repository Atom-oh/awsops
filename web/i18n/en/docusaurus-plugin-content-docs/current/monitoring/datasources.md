...
:::tip aws-data Route Integration
Datasource-related questions are processed through the `aws-data` route. The AI can analyze both Steampipe data and external datasources together.
:::
