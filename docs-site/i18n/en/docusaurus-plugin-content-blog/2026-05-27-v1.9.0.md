...
3. **Generate an AI warmup plan** — Bedrock Sonnet 5 produces a multi-phase per-resource scaling plan returned as structured JSON via the `PLAN_JSON` marker
...
| `src/lib/event-scaling-prompts.ts` | Bedrock Sonnet 5 prompts + `PLAN_JSON` parsing |
