...
**Upstream 릴리스 이력 — v0.9.0, 2026-08-22:** 이 릴리스는 커밋 `f22be3a08e1af902126f1a857959ec36d4e91fb3`에 태그된 [공개 `whchoi98/awsops` v2 릴리스](https://github.com/whchoi98/awsops/releases/tag/v0.9.0)의 이력이다. 이후 이 저장소로 통합된 소스이며 로컬 통합 수정은 이 `[Unreleased]`에서 추적한다. 날짜는 upstream 원본을 보존한다.
