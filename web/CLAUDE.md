...
| 디렉토리 | 내용 / Contents | 규모 |
|---|---|---|
| `app/` | 페이지 + API 라우트 (App Router) | 33 pages / 80 API routes |
| `lib/` | 도메인 로직 — React 비의존 (domain logic, mostly React-free) | 102 modules |
| `components/` | 클라이언트 컴포넌트 (client components) | 83 files, 11 subdirs |
