...
> Scoped to **P3** (consumes the P1f AgentCore fabric + P2 worker backbone + P1e EKS onboarding). Decision support: `~/Documents/K8sGPT_vs_AWSops_Research_20260604/` (deep-research, 22 sources). Depends on ADR-029 (**Accepted 2026-06-09**) for the remediation tier; diagnosis-only scope ships without it.
