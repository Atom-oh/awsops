...
AI 어시스턴트는 11개의 전문 라우트를 통해 다양한 질문에 답변합니다:
...
- "느린 트레이스 분석해줘" (Tempo/Jaeger) — Prometheus/Loki/Tempo/ClickHouse/Jaeger/Dynatrace/Datadog 지원

**10. AWS Data (리소스 목록/현황)**
- "EC2 인스턴스 목록 보여줘"
- "RDS 인스턴스 상태 확인"
- "Lambda 함수 런타임별 통계"
...
AI 어시스턴트는 Amazon Bedrock (Claude Sonnet 4.6 / Opus 4.8)을 기반으로 합니다.
