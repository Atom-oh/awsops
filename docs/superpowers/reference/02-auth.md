...
- [ADR-002 — Auth & Login](../../decisions/002-auth-and-login.md) — Accepted (2026-04-22). Edge-level rejection over ALB-native / Next.js-middleware / SigV4 alternatives; `viewer-request` over `origin-request`; HttpOnly cookie; decode-only at the app trusting the edge.
...
- Decision: `docs/decisions/002-auth-and-login.md` (esp. the 2026-06-03 post-acceptance RS256 note).
