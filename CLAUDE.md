...
- **EKS onboarding**: multi-select in `configure.mjs` → `eks.tf` grants the web task role an **Access Entry + AmazonEKSAdminViewPolicy** (cluster-scoped). Automatic kubeconfig registration/lookup UI is P3.
