...
- Budget at most **three attempts per instance per ISO week**. After three consecutively exhausted
...
Fallback queries extend discoverability while introducing cost, heuristic errors, and sample-dependent
false positives. Worker-generated chips cannot drive automated findings/alerts. Graph generation has a
