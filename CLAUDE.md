...
라이브 환경: 계정 `123456789012`, 도메인 `awsops-v2.atomai.click`, mgmt-vpc 재사용(`vpc-0123456789abcdef0`, 10.254.0.0/16).
...
Live env: account `123456789012`, domain `awsops-v2.atomai.click`, reused mgmt-vpc (`vpc-0123456789abcdef0`, 10.254.0.0/16).
