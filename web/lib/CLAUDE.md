...
## 역할 / Role
API 라우트와 컴포넌트가 공유하는 도메인 로직 113개 모듈 (React 비의존 위주, `collectors/` 포함). 테스트는 vitest로 소스 옆 colocate.
(113 domain-logic modules shared by API routes and components, mostly React-free. Tests colocated, vitest.)
