...
| 전체 쿼리 실패 (hydrate error) | SCP 차단 컬럼 | 해당 컬럼 제거 (mfa_enabled, attached_policy_arns, Lambda tags) — ADR-010 2026-09-02 개정: v2 sync 한정, 명시적 위험 수용 시 예외(현재 iam_role.attached_policy_arns 수용) |
