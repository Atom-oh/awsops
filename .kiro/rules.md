...
- **AI**: Bedrock Claude Sonnet 5 / Opus 4.8 (global.* cross-region), AgentCore Runtime (Strands), 8 Gateways, Code Interpreter
...
- Models: Sonnet 5 (`global.anthropic.claude-sonnet-5`), Opus 4.8 (`global.anthropic.claude-opus-4-8`), Haiku 4.5 (`global.anthropic.claude-haiku-4-5-20251001-v1:0`)
