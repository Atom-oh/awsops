...
Stats: 36 pages, 85 API routes, 86 components (`web/`), 18 consolidated ADRs, Terraform-managed (`terraform/v2/foundation`, no CDK).
...
```
awsops/
  web/                    # Next.js 14 thin-BFF: 36 pages, 85 API routes, 86 components
...
현황: 36 페이지, 85 API 라우트, 86 컴포넌트(`web/`), 18개 통합 ADR, Terraform 관리(`terraform/v2/foundation`, CDK 없음).
...
```
awsops/
  web/                      # Next.js 14 thin-BFF: 36 페이지, 85 API 라우트, 86 컴포넌트
