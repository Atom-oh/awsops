...
@img: ../../screenshots/overview/assistant-answer.png right 22%
...
> 권장사항만 제시 · **자동 적용 없음**
> (mutating 설치 버튼은 **ADR-005**로 영구 동결 — do-not-enable)

:::

@img: ../../screenshots/cost/cost-explorer.png center 30%
...
@img: ../../screenshots/resources/inventory.png center 32%
...
@img: ../../screenshots/resources/topology.png center 34%
...
@img: ../../screenshots/operations/ai-diagnosis.png center 30%
...
@img: ../../screenshots/observability/datasources.png center 40%
...
@img: ../../screenshots/resources/eks.png center 60%
...
@img: ../../screenshots/resources/eks-cluster.png center 60%
...
@img: assets/security-findings-pipeline.svg center 100%
...
@img: assets/compliance-benchmark-flow.svg center 100%
