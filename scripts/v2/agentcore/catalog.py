...
TARGETS = {
    ...
    "rds-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "execute_sql", "description": "SQL via Data API (SELECT only; PostgreSQL targets only — MySQL/MariaDB unsupported)", "inputSchema": {"type": "object", "properties": {"sql": _p("string", "SQL"), "resource_arn": _p("string", "ARN"), "secret_arn": _p("string", "Secret")}, "required": ["sql", "resource_arn", "secret_arn"]}},
