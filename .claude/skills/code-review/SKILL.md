...
- [ ] 목록 쿼리에 SCP 차단 컬럼 없음: mfa_enabled, tags, attached_policy_arns (No SCP-blocked columns in list queries) (ADR-010 2026-09-02 개정: 명시적 위험 수용 시 예외 — 현재 iam_role.attached_policy_arns 수용됨)
