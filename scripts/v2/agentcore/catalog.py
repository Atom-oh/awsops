...
TARGETS = {
    ...
    "inventory-read-target": {
        ...
        "tools": [
            ...
            {"name": "inventory_summary", "description": "Per-type host/self-scoped current_count from Aurora inventory resources, plus last-run row_count and sync freshness", "inputSchema": {"type": "object", "properties": {}}},
        ],
    },
